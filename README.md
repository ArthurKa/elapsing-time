[![All dependencies](https://img.shields.io/librariesio/release/npm/elapsing-time/3.0.0?style=flat-square "All dependencies of elapsing-time@3.0.0")](https://libraries.io/npm/elapsing-time/3.0.0)
