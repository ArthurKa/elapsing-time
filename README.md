[![All dependencies](https://img.shields.io/librariesio/release/npm/elapsing-time/3.0.1?style=flat-square "All dependencies of elapsing-time@3.0.1")](https://libraries.io/npm/elapsing-time/3.0.1)
